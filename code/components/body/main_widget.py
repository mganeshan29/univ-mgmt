...
class mainWidget:
    def __init__(self, title, master=None):
        ...
        dash_message.configure(background='white', foreground='#ca0a4a',font = self.header_font, text=title, width='200')
        ...
        active_button.configure(text=title, width='11',font = self.label_font, activebackground = "#d38a92", activeforeground ="#ca0a4a", bg = "#ea99a2", fg = "#ca0a4a",bd = '2', highlightthickness= 0)
    ...
    def onOpenProfile(self):
        ...
        mainWidget("Profile", self.root)    
        
    def onOpenLibrary(self):
        self.canvas1.destroy()
        mainWidget("Library", self.root)
        
    def onOpenFeeReport(self):
        self.canvas1.destroy()
        mainWidget("Fee Report", self.root)
    
    def onOpenMarks(self):
        self.canvas1.destroy()
        mainWidget("Marksheet",self.root)
