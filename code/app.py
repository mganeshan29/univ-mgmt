...
class Application:
    ...
    def __init__(self, master=None):
        ...
        faculty_button = tk.Button(self.toplevel1, command = lambda:self.openLogin("faculty"), activebackground = "#a2083b", activeforeground = "white")
        faculty_button.configure(text='faculty',background = "#ca0a4a",foreground = "white")
        faculty_button.place(anchor='nw', relheight='0.12', relwidth='0.8', relx='0.1', rely='0.47', x='0', y='0')
        
        student_button = tk.Button(self.toplevel1, command = lambda:self.openLogin("student"), activebackground = "#a2083b", activeforeground = "white")
        student_button.configure(text='Student',background = "#ca0a4a",foreground = "white")
    ...
    def openLogin(self,role):
      self.toplevel1.destroy()
      login_page.LoginPage(role)
